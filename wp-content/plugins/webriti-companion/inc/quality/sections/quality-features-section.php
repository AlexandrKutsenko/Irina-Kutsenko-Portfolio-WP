						...
						switch ( $choice ) {
							...
							<?php if ( ! empty( $title ) ) : 
								if(empty($link)){ ?>
									...
									?>
									<h2 ><a href="<?php echo $link; ?>" <?php if($open_new_tab!='no'){?>target="_blank" <?php }?> ><?php echo esc_html( $title ); ?></a></h2><?php
								}
							?>
		...
		'quality_service_default_content', json_encode(
			array(
				array(
					...
					'title'      => esc_html__( 'Beautiful Design', 'webriti-companion' ),
				...
				array(
					...
					'title'      => esc_html__( 'Global Customer Base', 'webriti-companion' ),
					'text'       => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'webriti-companion' ),
					'link'       => '#',
					'open_new_tab' => 'no',
				),
				array(
					'icon_value' => 'fa-edit',
					'title'      => esc_html__( 'Friendly Support', 'webriti-companion' ),
					'text'       => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'webriti-companion' ),
					'link'       => '#',
					'open_new_tab' => 'no',
				),
				array(
					...
					'title'      => esc_html__( 'A great value', 'webriti-companion' ),
					'text'       => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'webriti-companion' ),
					'link'       => '#',
					'open_new_tab' => 'no',
				),
...
{	
			...
			'service_one_title' => __('Beautiful Design','webriti-companion'),
			'service_two_title' => __('Global Customer Base','webriti-companion'),
			'service_three_title' => __('Friendly Support','webriti-companion'),
			'service_four_title' => __('A great value','webriti-companion'),

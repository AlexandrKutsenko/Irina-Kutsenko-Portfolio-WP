...
if ( ! function_exists( 'quality_portfolio' ) ) :
	...
	function quality_portfolio() {
		...
		$quality_portfolio_title    = isset($current_options['project_heading_one'])? $current_options['project_heading_one'] : esc_html__('Featured portfolio projects','webriti-companion');
		$quality_portfolio_subtitle = isset($current_options['project_tagline'])?$current_options['project_tagline']: esc_html__('Most popular of our works.','webriti-companion');
